...
public class Calculadora extends JFrame {
	...
	public Calculadora() {
		super();
		setSize(450, 300);
		setTitle("Calculadora Simple Palacios Hernández Alan Emmanuel 5IM9");
	...
	private void calcularResultado() {
		if (operacion.equals("+")) {
			...
			resultado = Math.abs(new Double(pantalla.getText()));
                ...
                else if (operacion.equals("floor")) {
			resultado = Math.floor(new Double(pantalla.getText()));
		}
